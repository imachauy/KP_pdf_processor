...
QUERY_OPERATION = os.getenv("QUERY_OPERATION", "")
QUERY_CONTENTSID = os.getenv("QUERY_CONTENTSID", "")
QUERY_CONTENTSNAME = os.getenv("QUERY_CONTENTSNAME", "")
QUERY_SCHOOLID = os.getenv("QUERY_SCHOOLID", "")
QUERY_COURSENAME = os.getenv("QUERY_COURSENAME", "")
QUERY_TIMESTAMP = os.getenv("QUERY_TIMESTAMP", "")
QUERY_CONTENTSURL = os.getenv("QUERY_CONTENTSURL", "")
